...
export async function GET() {
  try {
    ...
    const url = `https://us-central1-aiplatform.googleapis.com/v1/projects/adsliberty/locations/us-central1/publishers/google/models/gemini-2.0-flash:generateContent`;
