...
const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL ?? "https://3cliques-crm.vercel.app";
...
export async function POST(request: NextRequest) {
  ...
  if (!currentRole || !["owner", "gerente"].includes(currentRole.role)) {
  ...
  const fromName = `${tenantName} | 3Cliques CRM`;
