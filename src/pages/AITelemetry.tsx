...
/**
 * Componente reutilizável com o conteúdo da telemetria AI.
 * Usado dentro do Dashboard como tab.
 */
export function AITelemetryContent() {
...
// Default export = redirect para o Dashboard com tab ai-telemetry
export default function AITelemetry() {
  return <Navigate to="/?tab=ai-telemetry" replace />;
}
