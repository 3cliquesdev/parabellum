-- Fix search_path for vector deduplication functions

DROP FUNCTION IF EXISTS find_similar_articles(UUID, FLOAT, INT);
DROP FUNCTION IF EXISTS check_duplicate_articles(TEXT, UUID, FLOAT);
